  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
      ...
      <div className="prose max-w-none">
        ...
        <ul>
          <li>
            <strong>기본 스트레스 금리: 1.5%p</strong> (3단계, 전국 기준)
          </li>
          <li>
            <strong>수도권·규제지역 주택담보대출</strong>: 2025년 10월 &lsquo;10.15 부동산대책&rsquo;으로 스트레스 하한금리가 <strong>3.0%p</strong>로 상향됐어요(변동형 기준)
          </li>
          <li>
          ...
          <li>
            ...
            적용돼요(고정기간·변동주기가 길수록 적용비율이 더 낮아져요). 고정형 비중이 높을수록 스트레스 부담이 줄어드는 구조예요.
          </li>
        </ul>
        <p>
          핵심은 <strong>스트레스 금리만큼 원리금이 커져서 받을 수 있는 한도가 줄어든다</strong>는
          점이에요. 예를 들어 실제 금리가 4.5%라도 수도권 변동형은 심사를 7.5%(4.5%+3.0%p)로 계산하니, 같은 소득이라도
        ...
        <p>
          ...
          수도권 변동형 기준 스트레스 금리 3.0%p를 더한 7.5%로 심사하면, DSR 40%를 채우는 대출 한도는 대략
          <strong> 2억 4천만원대</strong>로 계산돼요. 같은 조건에서 스트레스를 빼고 4.5%로만 계산하면
          3억 3천만원대이니, 스트레스 DSR 때문에 약 8천만~9천만원 한도가 줄어드는 셈이죠. (지방 주담대는 한시 유예로 0.75%p만 적용돼 차이가 훨씬 작아요.)
        </p>
