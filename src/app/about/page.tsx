  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="prose">
        ...
        <h2>콘텐츠 신뢰성 원칙</h2>
        <p>
          돈과 관련된 정보는 작은 오차가 큰 손해로 이어질 수 있습니다. 그래서
          쉬운재테크는 다음 원칙을 지킵니다.
        </p>
        <ul>
          <li>
            <strong>1차 출처 우선</strong> — 금리·세율·공제 한도·법령 같은
            핵심 수치는 추측하지 않고 국세청·금융감독원·한국은행 등 공식
            자료에서 확인한 값만 싣습니다. 출처가 엇갈릴 때는 본문에 그 사실과
            기준 시점을 함께 밝힙니다.
          </li>
          <li>
            <strong>실제 사례·시뮬레이션 중심</strong> — &ldquo;유리합니다&rdquo;
            같은 막연한 표현 대신, 연봉·납입액·기간을 넣어 직접 계산한 숫자로
            보여드립니다. 독자가 자기 상황에 대입해볼 수 있도록 가정과 계산
            과정을 공개합니다.
          </li>
          <li>
            <strong>최신성 관리</strong> — 세법·금리·정부 정책은 자주 바뀝니다.
            관련 글은 기준 연도와 시행일을 명시하고, 변경이 생기면 본문을
            갱신하며 수정 시점을 남깁니다.
          </li>
          <li>
            <strong>광고와 콘텐츠 분리</strong> — 광고 수익이 글의 결론을
            바꾸지 않습니다. 특정 상품을 과장하거나 클릭을 유도하지 않으며,
            장단점을 함께 다룹니다.
          </li>
        </ul>
        <p>
        ...
        <ul>
          ...
          <li>
            <strong>광고·제휴·정정 요청</strong> — 동일 문의 페이지로 접수
          </li>
        </ul>
      </div>
    </div>
